            ...
            <div class="grid grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1 p-6">
                    ...
                    <form class="max-w-sm mx-auto" autocomplete="off">
                        ...
                        <button type="submit" class="text-white bg-primary-500 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 sm:px-8 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Register</button>
                    </form>
